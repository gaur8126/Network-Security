...
MODEL_TRAINER_OVER_FITTING_UNDER_FITING_THRESHOLD :float = 0.05


"""
Model Evaluation   related constant start with MODEL_TRAINER VAR name
"""
...
MODEL_PUSHER_SAVED_MODEL_DIR = SAVE_MODEL_DIR



TRAINING_BUCKET_NAME= "network.security"
