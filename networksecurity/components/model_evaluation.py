...
from networksecurity.utils.main_utils.utils import load_object,save_object,write_yaml_file,read_yaml_file_path
...
class ModelEvaluation:
    ...
    def initiate_model_avaluation(self)-> ModelEvaluationArtifact:
        try:
            valid_train_file_path = self.data_validation_artifact.valid_train_file_path
            valid_test_file_path = self.data_validation_artifact.valid_test_file_path

            # valid tain and test file dataframe 
