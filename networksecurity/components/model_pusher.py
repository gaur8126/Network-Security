...
from networksecurity.entity.artifact_entity import ModelPusherArtifact,ModelTrainerArtifact,ModelEvaluationArtifact
from networksecurity.entity.config_entity import ModelEvaluationConfig,ModelPusherConfig
import os ,sys 
...
class ModelPusher:
    ...
    def initiate_model_pusher(self) -> ModelPusherArtifact:
        try:
            ...
            #create model dir to save model 
