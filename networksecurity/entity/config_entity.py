...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.expected_accuaracy:float = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold = training_pipeline.MODEL_TRAINER_OVER_FITTING_UNDER_FITING_THRESHOLD
...
class  ModelPusherConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.saved_model_path = os.path.join(
            training_pipeline.SAVE_MODEL_DIR,
            f"{timestamp}",
            training_pipeline.MODEL_FILE_NAME
        )